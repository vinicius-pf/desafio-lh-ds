...
# titanic_classification documentation build
...
from titanic_classification import __version__ as release
...
htmlhelp_basename = "titanic_classificationdoc"
...
texinfo_documents = [
    (
        ...
        author,
        "titanic_classification",
        "Project titanic_classification codebase.",
        "Data-Science",
    )
]
